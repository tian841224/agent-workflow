...
def main() -> int:
    ...
    print("task gate/knowledge/retro contracts passed")
    checks=[("compile",[sys.executable,"-m","compileall","-q",str(root/"agent_workflow")]),
            ("contract",[sys.executable,str(root/"agent_workflow.py"),"project-doc","--action","Check","--doc",str(root/"README.md")]),
            ("orchestration",[sys.executable,str(root/"agent_workflow.py"),"orchestrate","--help"])]
