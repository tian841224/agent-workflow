...
10. Standard tasks may be marked `done` after completion criteria, validation, and all selected capabilities are complete. Coordinator/worker or Elevated tasks use `close-task.py` for the full legacy gate. Use `paused`, `blocked`, or `superseded` truthfully.
