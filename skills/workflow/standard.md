...
適用：單一功能的新增或行為變更，需求已明確，波及侷限本功能（判準見 SKILL.md）。刻意精簡：不比照重軌拆「PM 寫意圖、architect 補手段」——需求已明確不需要 PM 釐清，由 architect 一人寫完 mini-spec，單人設計驗收條目的盲點交由 qa 的探索性測試補償。PM 不出場。
...
M4 驗收：qa 逐條執行、當場比對 expect 判定 PASS/FAIL；前端模糊項由主對話整理
   交使用者裁決；
